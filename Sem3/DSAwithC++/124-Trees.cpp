...
// Tree traversals : 
// Breadth First Traversal (Level order traversal) They are same in case of trees
...
//     }
//     if (level > maxLevel){
        //means this is the first time we are enocuntering this level, and since we are 
        //recursively calling th eleft part first, the lfet most nodes are bound to reach this
        //condition first
//         maxLevel = level;
//         cout << node->key << " ";
//     }
