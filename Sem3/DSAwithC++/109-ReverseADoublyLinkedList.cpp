...
/*
Explanation : The key idea here is that humein next and prev ko replace karna hai each node ke and then prev pe jana hai uke end mein last element return kar dena hai
*/
