...
let random_num
let place1 = document.getElementById("displayhere")
let generator = document.getElementById("DJ")
let place2 = document.getElementById("answer")
generator.onclick = () =>
{
    random_num = Math.floor(dadJokes.length * Math.random())
    place1.innerHTML = dadJokes[random_num]["question"]
    place2.innerHTML = dadJokes[random_num]["answer"]
}